...
שלוש תנועות, והן מלוות את כל מה שקורה: לוח שנבנה מחדש עולה בהדרגה — בעת החלפת משתמש, החלפת האירוע
הנבחר, מעבר בין אירועים בלשונית האירועים, וברגע שקובץ חדש נטען ומחליף את השוק כולו; יתרה שהשתנתה
גדלה ומתיישבת אחרי כל פעולה; ומעבר בין הלשוניות מחליק את הלשונית הנכנסת מהצד שאליו נעים — ימינה
נכנס מימין, חזרה נכנס משמאל, כך שהתנועה מסכימה עם כיוון המעבר במקום לסתור אותו.

פעולה שנדחתה אומרת זאת במילים, בחלון שצריך לסגור, ולא בתנועה. זו תשובה ברורה יותר מלוח שמרטט
מאחורי ההודעה.

הארוכה מבין השלוש רצה 320 מילישניות. כשהמתג כבוי הקוד אינו נוגע באף רכיב, וכל תנועה מחזירה את הרכיב
