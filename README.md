...
**198 בדיקות JUnit 5**, כולן עוברות. דורש את `junit-platform-console-standalone.jar` בתיקיית
...
**198 בדיקות JUnit 5**, בפיתוח מונחה בדיקות: הבדיקה נכתבת ראשונה, נצפית נכשלת, ורק אז נכתב הקוד.
